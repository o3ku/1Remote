...
*/
    ...
    {
        private static Screen PrimaryScreenOrFallback => Screen.PrimaryScreen ?? Screen.AllScreens[0];
        ...
        {
            var k = new ScreenInfoEx(PrimaryScreenOrFallback).ScaleFactor;
        ...
        {
            var primaryScreen = PrimaryScreenOrFallback;
        ...
        public static uint GetPrimaryScreenScaleFactor()
        {
            ...
            try
            {
                ...
                sf = (uint)(100 * PrimaryScreenOrFallback.Bounds.Width / SystemParameters.PrimaryScreenWidth);
            }
            catch (Exception)
            {
                sf = 100;
